       ...
       <nav class="navbar bg-dark" id="navbar">
        <div class="container">
            <div class="navbar-brand">
                <img src="/connect2local/asset/image/logo/logo.png" height="50" alt="50" class="rounded-circle">
            </div>
    ...
    <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasStart" aria-labelledby="Navigation">
        ...
        <div class="offcanvas-body">
            <div class="profile-image d-flex justify-content-center align-items-center ps-4" style="width:100%;height:30%">
                <img src="/connect2local/asset/image/logo/logo.png" alt="" style="height:70%" class="rounded-circle">
            </div>
