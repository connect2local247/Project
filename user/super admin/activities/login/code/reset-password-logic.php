<?php
        ...
        function email_exists($email) {
            $check_email_query = "SELECT * FROM customer_register WHERE C_EMAIL = '$email'";
        ...
        function update_password($email, $password) {
            if (email_exists($email)) {
                $update_password_query = "UPDATE customer_register SET C_PASSWORD = '$password' WHERE C_EMAIL = '$email'";
        ...
        if(isset($_POST['submit'])){
            ...
            header("location:/connect2local/user/customer/activities/login/form/forgot-password.php?code=$verify_code");
        }
?>