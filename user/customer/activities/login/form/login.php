...
<head>
    ...
    <title>Connect2local - Customer Login</title>
...
<div class="modal" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                    ...
                    if(isset($_SESSION['greet-message'])){
                        echo "
                            ...
                            echo " 
                                  <script>
                                          setTimeout(function(){
                                              window.location.href='/connect2local/user/customer/panel/customer-panel.php';
                                          },5000);    
                                  </script>
                              ";
    ...
    <div class="container">
        <form action="/connect2local/user/customer/activities/login/code/check-login-detail.php" method="post" class="d-flex flex-column align-items-center justify-content-center" style="height:90vh;width: 100%;">
            <div class="my-4">
                    <?php
            ...
            <fieldset class="p-3 border rounded" id="form-fieldset">
                ...
                <div class="mt-3 d-flex align-items-center justify-content-between px-2">
                    <a href="/connect2local/user/customer/activities/register/form/basic-info.php" class="nav-link text-secondary" style="font-size:15px">Create an Account</a>
                    <a href="/connect2local/user/customer/activities/login/form/user-verification.php" class="nav-link text-secondary" style="font-size:15px">Forgot Password</a>
                 </div>
