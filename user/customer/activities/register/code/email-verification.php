    ...
    if(isset($_POST['verify'])){
        ...
        $template = "
            <div $styles>
                ...
                <p>Hi $name,</p>
                <p>Thank you for signing up with Connect2Local! To complete your registration, please use the following verification code:</p>
        ...
        header("Location:/connect2local/user/customer/activities/register/form/customer-verification.php");
    }
