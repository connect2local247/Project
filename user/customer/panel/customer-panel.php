            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content text-bg-white">
                    ...
                    <div class="modal-body">
                        <?php
                            $currentTime = "2023-11-30 9:30:00";
                            echo "<div class='d-flex text-bg-white shadow bg-body-tertiary border p-2 rounded position-relative'>
                                <div class='ms-2 d-flex flex-column' style='gap:4px'> 
                                    <div id='notification-title'>Test Notification</div>
                                    ...
                                    <p id='notification-message' style='text-align:justify'>congratulation you have succesfully registerd on our site free for to use our platform i hope our platform is useful for you and you get what you want. </p>
                                </div>     
        ...
        <nav class="navbar text-bg-dark" style="height:70px">
            <div class="container">
                    <div class="menu-icon d-flex fs-4" style="gap:10px;" >
                        ...
                        <i class="fa-solid fa-house" onclick="location.href='/connect2local/index.php'"></i>
                    </div>
                    <div class="logo">
                    ...
                    <div class="menu-icon d-flex fs-4" style="gap:10px;">
                        ...
                        <i class="fa-solid fa-bell position-relative" id="notification-bell" data-bs-target="#notificationModal" data-bs-toggle="modal"><span id="notify-icon" class="position-absolute top-0 start-100 translate-middle badge border border-light rounded-circle bg-danger p-1"><span class="visually-hidden">unread messages</span></span></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="" class="m-5 col-lg-12 col-md-12 d-flex justify-content-lg-center justify-content-md-start justify-content-center">
                    ...
                    <div class="">
                        <button onclick="requestNotificationPermission()">sent notification</button>
                        <script src="/connect2local/asset/script/sent-notification.js"></script>
                    </div>
                </div>
            </div>
        </div>
