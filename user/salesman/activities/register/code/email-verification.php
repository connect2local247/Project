    ...
    if(isset($_POST['verify'])){
        ...
        $template = "
            <div $styles>
                ...
                <p>Hi $name,</p>
                <p>Thank you for signing up with Connect2Local as Business Person. To complete your registration, please use the following verification code:</p>
        ...
        header("Location:/connect2local/user/salesman/activities/register/form/salesman-verification.php");
    }
