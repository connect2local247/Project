...
<head>
    ...
    <title>Salesman - Email Verification</title>
...
<body>
        ...
        <?php
                    if(isset($_SESSION['greet-message'])){
                        ...
                        if(isset($_SESSION['is_resend'])  && $_SESSION['is_resend'] == "Yes"){
                            ...
                            <script>
                                    setTimeout(function(){
                                        window.location.href='/connect2local/user/salesman/activities/register/verification/email-verification-code.php';
                                    },5000);    
                            </script>
                        ";
                        unset($_SESSION['is_resend']);
                            ...
                            echo " 
                                  <script>
                                          setTimeout(function(){
                                              window.location.href='/connect2local/user/salesman/activities/register/form/register-finish.php';
                                          },5000);    
                                  </script>
                              ";
    ...
    <div class="container" >
        <form action="/connect2local/user/salesman/activities/register/code/match-code-logic.php" method="post" class="d-flex flex-column justify-content-center align-items-center" style="height:90vh;width:100%;">
        <div class="my-4 col-lg-8 col-12">
            <?php
            if (isset($_SESSION['error'])) {
                $error = $_SESSION['error'];
                echo "<p id='error-message' class='text-bg-secondary text-center col-12 p-2 rounded m-auto w-75' style='line-height:30px'><i class='fa-solid fa-triangle-exclamation text-warning px-1 fs-5'></i> $error</p>";
            }
            ?>
        </div>
            <fieldset class="border p-4 rounded-2  position-relative" id="form-fieldset">
                ...
                <div class="mt-2 d-flex justify-content-end px-2">
                    <a href="/connect2local/user/salesman/activities/register/code/resend-code.php" class="nav-link text-primary">Resend Code</a>
                </div>
