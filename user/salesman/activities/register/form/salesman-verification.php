...
<head>
    ...
    <title>Salesman Verification</title>
...
<body>
    <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            ...
            ?>
    <div class="container" >
        <form action="/connect2local/user/salesman/activities/register/code/email-verification.php" method="post"class="d-flex justify-content-center align-items-center" style="height:90vh;width:100%;">
            <fieldset class="border p-4 rounded  position-relative" id="form-fieldset">
                <legend class="text-center fw-bold fs-3 my-5">Salesman Verification</legend>
                <div class="position-absolute end-0 top-0 me-4 mt-3">
                <i class="fa-solid fa-circle-info fs-4 text-primary"></i>
                </div>
                <div class="mt-5">
                    <label for="phone" class="form-label">Contact</label>
                    <input type="tel" name="contact" class="form-control" placeholder="Phone Number" id="phone" value="<?php if(isset($_SESSION['contact'])) echo $_SESSION['contact'];?>" readonly>            
                </div>
                ...
                <div class="mt-3 d-flex justify-content-between">
                        <a href="/connect2local/user/salesman/activities/register/form/contact-detail.php" class=" nav-link px-5 py-2 rounded text-bg-primary bg-gradient" style="border:grey; width:150px;height:45px;">Previous</a>
                        <input type="submit" name="verify" value="Verify"  class="btn text-bg-success bg-gradient py-2 px-5">
                </div>
            </fieldset>
        </form>
    </div>
