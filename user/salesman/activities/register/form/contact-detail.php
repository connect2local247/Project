...
<head>
    ...
    <title>Salesman - Contact Info</title>
...
<body>
    ...
    <form action="/connect2local/user/salesman/activities/register/code/contact-detail-logic.php" method="POST" class="p-2 d-flex flex-column justify-content-center align-items-center" style="height:90vh;width:100%">
    <div class="my-4">
        <?php
            ...
            <?php
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                setTimeout(function(){
                                    window.location.href='/connect2local/user/salesman/activities/register/form/salesman-verification.php';
                                },5000);
                            });
                        </script>";
        ...
        <fieldset class="border p-3 rounded  position-relative" id="form-fieldset">
            ...
            <div class="position-absolute end-0 top-0 me-4 mt-3">
             ...
             <div class="mt-2">
                <label for="contact" class="form-label ps-1">Contact</label>
             ...
             <div class="mt-3 d-flex align-items-center justify-content-between px-2" style="gap:10px">
                <a href="/connect2local/user/salesman/activties/register/form/business-detail.php" class=" nav-link px-5 py-2 rounded text-bg-primary bg-gradient" style="border:grey; width:150px;height:45px;">Previous</a>
