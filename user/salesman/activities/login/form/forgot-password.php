...
<body>
    ...
    <div class="container">
        <form action="/connect2local/user/salesman/activities/login/code/reset-password-logic.php" method="POST" class="d-flex flex-column align-items-center justify-content-center" style="height:90vh;width: 100%;">
            ...
            <?php
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                setTimeout(function(){
                                    window.location.href='/connect2local/user/salesman/activities/login/form/login.php';
                                },5000);
                            });
                        </script>
                        ";
