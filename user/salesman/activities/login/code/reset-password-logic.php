<?php
        ...
        function email_exists($email) {
            $check_email_query = "SELECT * FROM salesman_register WHERE S_EMAIL = '$email'";
        ...
        function update_password($email, $password) {
            if (email_exists($email)) {
                $update_password_query = "UPDATE salesman_register SET S_PASSWORD = '$password' WHERE S_EMAIL = '$email'";
        ...
        if(isset($_POST['submit'])){
            ...
            header("location:/connect2local/user/salesman/activities/login/form/forgot-password.php?code=$verify_code");
        }
?>