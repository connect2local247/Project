...
function match_detail($email, $password) {
    ...
    $query = "SELECT S_PASSWORD FROM salesman_register WHERE S_EMAIL = '$email'";
    ...
    if ($result) {
        ...
        $stored_password = $row['S_PASSWORD'];
...
header("location:/connect2local/user/salesman/activities/login/form/login.php");
?>
