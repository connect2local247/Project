<?php
    ...
    function check_mail_exist($email){
            $check_query = "SELECT S_EMAIL from salesman_register where S_EMAIL = '$email'";
    ...
    if(isset($_POST['submit'])){
            ...
            $verificationLink = "http://localhost/connect2local/user/salesman/activities/login/form/forgot-password.php?code=$verificationCode";
        ...
        header("location:/connect2local/user/salesman/activities/login/form/user-verification.php");
