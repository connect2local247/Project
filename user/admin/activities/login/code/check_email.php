<?php
    ...
    function check_mail_exist($email){
            $check_query = "SELECT EMAIL from admin_register where EMAIL = '$email'";
    ...
    if(isset($_POST['submit'])){
            ...
            $verificationLink = "http://localhost/connect2local/user/admin/activities/login/form/forgot-password.php?code=$verificationCode";
        ...
        header("location:/connect2local/user/admin/activities/login/form/user-verification.php");
