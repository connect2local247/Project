...
<body class="d-flex align-items-center flex-column" style="height:100vh;width:100%">
    ...
    <form action="/connect2local/user/admin/activities/register/code/basic-detail-logic.php" method="POST" class="p-2 d-flex flex-column justify-content-center align-items-center" style="height:80vh;width:100%">
    <div class="my-4">
        <?php
            ...
            <?php
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                setTimeout(function(){
                                    window.location.href='/connect2local/user/admin/activities/register/form/contact-detail.php';
                                },5000);
                            });
                        </script>";
