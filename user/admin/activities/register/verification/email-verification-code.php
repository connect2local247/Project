...
<div class="modal" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                    ...
                    if(isset($_SESSION['greet-message'])){
                        ...
                        unset($_SESSION['is_resend']);
                            ...
                            echo " 
                                  <script>
                                          setTimeout(function(){
                                              window.location.href='/connect2local/user/admin/activities/register/form/security-detail.php';
                                          },5000);    
                                  </script>
                              ";
    ...
    <div class="container" >
        ...
        <form action="/connect2local/user/admin/activities/register/code/match-verification-code.php" method="POST" class="d-flex flex-column justify-content-center align-items-center" style="height:90vh;width:100%;">
            <div class="my-4">
                <?php
            ...
            <fieldset class="border p-4 rounded-2" id="form-fieldset">
                ...
                <div class="mt-2 d-flex justify-content-end px-2">
                    <a href="/connect2local/user/admin/activities/register/code/resend-code.php" class="nav-link text-primary">Resend Code</a>
                </div>
